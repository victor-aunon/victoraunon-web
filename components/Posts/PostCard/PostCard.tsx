        ...
        >
          <Card className="h-full overflow-hidden border-zinc-800 bg-zinc-900 hover:border-zinc-600 transition-colors">
            ...
            <CardContent className="p-4 flex flex-col gap-2">
              <h2 className="text-xl font-semibold text-zinc-100 leading-snug line-clamp-2 group-hover:text-white transition-colors [word-spacing:0.2rem]">
                {postInfo.title}
              </h2>
